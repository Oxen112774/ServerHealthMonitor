...
Server‑Health‑Monitor‑v2
🔥 仓库迁移声明（顶部醒目位置）
📢 本项目原存放于 GitHub，受上传限制无法正常迭代，现已完整迁移至 Gitee，
✅ 当前Server Health Monitor主仓库地址：shturl.cc/HQsrh58yZXAXWew2QG3anmQg1P‑health‑monitor‑v2.git
旧 GitHub 仓库仅做历史备份，所有新功能、Bug 修复全部在当前 Gitee 仓库更新，GitHub 不再专做此脚本维护。
⚠️ 重要：SCP:Secret‑Lab 服务端适配仅为内置示例模块；本项目是通用企业级服务器健康监控工具，并非 SCP‑SL 专用工具。
